(function() {
  ...
  _this.onStart = function() {
    return console.log("onStart receiver");
  };
  ...
  onRun = function(mapBufferId, mapBufferObj) {
    ...
    switch (mapBufferId) {
      case 0:
        ...
        break;
      case 1:
        return console.log("onRun receiver _bufferToWriteTest");
      default:
        return console.log("onRun receiver, unknown buffer");
    }
  };
  ...
  _this.onStop = function() {
    return console.log("onStop receiver");
  };
